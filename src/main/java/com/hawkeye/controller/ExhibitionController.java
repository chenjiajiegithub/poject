...
import com.hawkeye.service.ClassicService;
import com.hawkeye.service.SoonReleaseService;
import com.hawkeye.service.impl.PopularServiceImpl;
...
public class ExhibitionController {
     ...
     * @return
     */
    @RequestMapping("/heatwordofmouth")
    @ResponseBody
    public List<Movie> heatWordOfMouth(){
        return billboardService.getHeatWordOfMouth();
    }
}
